    ...
    case viewRest v of
        ...
        (s:ss) ->
            ...
            in case s of
                   ...
                   Done mb ->
                       v' { viewBoard = maybe (viewBoard v) id mb
                          , viewFocus = Nothing
            ...
            glyph =
                case indexGrid (viewBoard v) p of
                    ...
                    Just s ->
                        ...
                        translate (-15) (-15) $
                        scale 0.3 0.3 $ color ink $ text [symbolChar s]
        in translate x y $
           pictures
...
hud v =
  ...
  where
    ...
    body =
        ...
        , "step " ++ show (viewSteps v) ++ "    " ++
          show (viewPlaced v) ++ " placed    " ++
          show (viewUndone v) ++ " backtracked"
        , status ++ "    " ++
          (if viewRunning v
               then "running"
               else "paused")
