...
import qualified Data.Grid.Atlas.CubeMap    as Cube
import qualified Data.Grid.Atlas.Klein      as Klein
import qualified Data.Grid.Atlas.Mobius     as Mobius
import qualified Data.Grid.Atlas.Projective as Proj
import           Data.Grid.Atlas.Rect       (Crossing (..), Heading (..),
                                             crossedSeam, reversedFrame)
