...
import           Grid.Sized.Internal.Type (requiring)
...
-- library needs it in exactly one place --- 'Grid.Sized.Coord.Class.reifyCoord',
-- used by 'Grid.Sized.Grid.Grid.shrinkGrid' to turn a window offset into a
