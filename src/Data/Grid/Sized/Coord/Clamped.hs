...
-- 'Data.Grid.Sized.Coord.Periodic.Periodic', which wraps around modularly.
--
...
-- displacement, and 'Data.Grid.Sized.Coord.offsetCoord' reports leaving the axis
...
instance (1 <= n, KnownNat n) => AffineSpace (Clamped n) where
  ...
  --
  -- The same 360,000 offsets through a two-axis 'Data.Grid.Sized.Coord.Coord' went
  ...
  -- @'Data.AffineSpace.AffineSpace' ('Data.Grid.Sized.Coord.Coord' cs)@, which is
