...
-- vector function the library does not wrap -- "Data.Grid.Sized.Grid.Unsafe" has the
-- escape hatch, and it is not re-exported by "Data.Grid.Sized".
module Data.Grid.Sized.Grid
  ( -- * The grid type
    Grid
    -- * Construction
